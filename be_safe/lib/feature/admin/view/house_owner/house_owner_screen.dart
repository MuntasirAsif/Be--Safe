...
import 'package:be_safe/feature/house_owner_screens/repository/house_onwer_repository.dart';
import 'package:flutter/material.dart';
import '../../../../model/hotel_model.dart';
import '../../../../model/house_owner_model.dart';

class HouseOwnerScreen extends StatefulWidget {
  const HouseOwnerScreen({super.key});

  @override
  State<HouseOwnerScreen> createState() => _HouseOwnerScreenState();
}

class _HouseOwnerScreenState extends State<HouseOwnerScreen> {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final unregisteredHotels = hotels
                          .where((hotel) =>
                      hotel.isRegistered && hotel.hotelId == houseOwner.hotelId)
                          .toList();

...
class PaidPaymentsScreen extends StatelessWidget {
  const PaidPaymentsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final List<PaymentModel> paidPayments = List.generate(
      8,
          (index) => PaymentModel(
        paymentId: 'PAID1234$index',
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paid Hotel Payments'),
      ),
